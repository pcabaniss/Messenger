...
class ChatViewController: MessagesViewController {
    ...
    private func presentInputActionSheet() {
        let actionSheet = UIAlertController(title: "Attatch Media",
    ...
    private func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Attatch Photo",
                                            message: "Where would you like to attatch the photo from?",
                                            preferredStyle: .actionSheet)
...
/// All file names must be unique!!!!!!!!!!!!!!!!!
        ...
        StorageManager.shared.uploadMessagePhoto(with: imageData, fileName: fileName, completion: { [weak self] result in
            ...
            case.failure(let error):
                print("Failed to upload photo for message: \(error)")
            }
        })
        //Send message
    }
